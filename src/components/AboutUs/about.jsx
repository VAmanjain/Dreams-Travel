...
const About = () => {
  return (
    <div className="about" name="about">
      ...
      {/* <div className=" data  container flex  gap-6">

      <div className="leftContent grid">
        <div className="head">
        ...
        <p>
          ...
          growth and the lasting memories it creates. Our goal is to enable you
          to embark on journeys that go beyond mere vacations, enriching your
          life with moments of wonder, discovery, and connection.
        </p>
          </div>
      </div>
      ...
      <div className="rightcontent">
        ...
        <p>
          <ul>
            <li>
              <span>Inspiration</span>: We inspire you to dream bigger, venture
              farther, and seek out the extraordinary.
            </li>
            <li>
              <span>Transformation</span>:We aim to transform your travel dreams
              into vivid, life-altering experiences.
            </li>
            <li>
              <span>Memories</span>: We're here to help you craft memories that
